...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { feedback: @name.feedback, score: @name.score, team: @name.team, title: @name.title } }, as: :json
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { feedback: @name.feedback, score: @name.score, team: @name.team, title: @name.title } }, as: :json
    assert_response 200
  end
